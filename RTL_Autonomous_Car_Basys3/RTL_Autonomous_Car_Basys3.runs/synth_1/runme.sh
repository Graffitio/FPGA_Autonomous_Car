...
HD_PWD='F:/Ian_Jung/workplace/cora_z7/cora_cpu_2019/RTL_Autonomous_Car_Basys3/RTL_Autonomous_Car_Basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Autonomous_Car_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Autonomous_Car_Top.tcl
